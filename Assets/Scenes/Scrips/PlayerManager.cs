...
>>>>>>> èµ°ã‚Šã¨ãƒ—ãƒ¬ã‚¤ãƒ¤ãƒ¼ãƒžãƒãƒ¼ã‚¸ãƒ£ãƒ¼åˆ†ã‘ã‚‹
    ...
    void Attack()
    {
        ...
        attackCollider.enabled = true; // UŒ‚”ÍˆÍ‚ðˆêŽž“I‚É—LŒø‰»

        // ƒqƒbƒg‚µ‚½“G‚ðŠi”[‚·‚éƒŠƒXƒg‚ð—pˆÓ
        List<Collider2D> hitEnemies = new List<Collider2D>();

        // ƒI[ƒo[ƒ‰ƒbƒv‚µ‚½ƒRƒ‰ƒCƒ_[‚ðŽæ“¾
        ...
        attackCollider.enabled = false; // UŒ‚Œã‚É–³Œø‰»
    }
...
>>>>>>> èµ°ã‚Šã¨ãƒ—ãƒ¬ã‚¤ãƒ¤ãƒ¼ãƒžãƒãƒ¼ã‚¸ãƒ£ãƒ¼åˆ†ã‘ã‚‹
    public void OnDamage(int damage)
    {
        ...
        Debug.Log("ƒvƒŒƒCƒ„[‚ª" + damage + "ƒ_ƒ[ƒW‚ðŽó‚¯‚½");
        //HPƒo[‚ÌŠÇ—‚·‚é‚â‚Â‚Å‚·
